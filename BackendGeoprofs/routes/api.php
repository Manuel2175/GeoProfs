...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('verlofaanvraag', [VerlofAanvraagController::class, 'indexverlofaanvraag'])->middleware(\App\Http\Middleware\checkManagement::class);
        Route::prefix('user/{user}')->group(function () {
            Route::apiResource('verlofaanvraag', VerlofAanvraagController::class);
            Route::put('/verlofaanvraag/{verlofAanvraag}/reject', [VerlofAanvraagController::class, 'reject'])->middleware(checkManagement::class);
            Route::put('/verlofaanvraag/{verlofAanvraag}/approve', [VerlofAanvraagController::class, 'approve'])->middleware(checkManagement::class);
        });
});

...
axios.defaults.baseURL = import.meta.env.VITE_API_URL || 'http://laravel.test/api';
...
export const ensureCsrfToken = async () => {
  try {
    ...
    await axios.get('/sanctum/csrf-cookie', { baseURL: import.meta.env.VITE_APP_URL || 'http://laravel.test' });
